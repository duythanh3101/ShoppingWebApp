    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        utilities.notify('Update role successful', 'success');
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    utilities.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    utilities.stopLoading();
                },
                error: function () {
                    utilities.notify('Has an error in save permission progress', 'error');
                    utilities.stopLoading();
                }
            });
        });
